...
def get_mean_and_std(dir_img):
    ...
    # Get dataloader
    trainloader = get_dataloader(data_file=dir_img, img_size=380, batch_size=128)
    ...
    print("Dataset Std Dev: ", std.tolist())

    return mean, std

if __name__ == "__main__":
    print('Calculating Mean and Std Dev...')
    get_mean_and_std(dir_img="../dataset/train_data.csv")
